...
const val GET_AMPHIOBIANS = "android-basics-kotlin-unit-4-pathway-2-project-api.json"
...
private val retrofit: Retrofit = Retrofit.Builder().baseUrl(BASE_URL).addConverterFactory(MoshiConverterFactory.create(
    moshi)).build()
